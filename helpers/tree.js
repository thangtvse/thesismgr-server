...
var createNode2 = function (node) {
    return "<li style='padding-left: 15px;'><a href=\"#\"><i class=\"fa arrow\"></i> "+ node.name +"<span class=\"fa \"></span></a><ul class='nav'>";
};
var createLeaf2 = function (node) {
    return "<li style='padding-left: 15px;'><a href='#'><i class=\"fa minus\"></i>" + node.name + "</a><ul>";
};